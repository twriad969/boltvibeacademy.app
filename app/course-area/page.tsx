...
import { Menu, X, Youtube, Play, BookOpen, CheckCircle, Lock, ChevronLeft, ChevronRight, AlertCircle } from 'lucide-react';
          ...
          <div className="flex-1 overflow-y-auto p-2">
            <div className="space-y-1">
              {Object.entries(
                ...
                <div key={moduleName}>
                  <h3 className="font-hind-siliguri px-3 py-2 text-sm font-semibold text-muted-foreground">
                    {moduleName}
                  </h3>
...
সাপোর্ট বা কোনো সমস্যার ক্ষেত্রে দয়া করে #support-requests চ্যানেলে মেসেজ দিন। যদি কোনো টেকনিক্যাল সমস্যা বা কনফিউশন ফেস করেন, তাহলে একটি স্ক্রিন রেকর্ড করে সেই চ্যানেলেই পাঠিয়ে দিন — আপনার ইস্যুটি যত দ্রুত সম্ভব সমাধান করে দেওয়া হবে। </p>
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                <Button 
                  ...
                  onClick={() => window.open('https://wa.me/+8801744136934', '_blank')}
                >
                ...
                <Button 
                  ...
                  onClick={() => window.open('https://discord.gg/zXgnCfcC', '_blank')}
                >
                  <svg className="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
