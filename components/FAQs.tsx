...
export function FAQs() {
  const faqItems = [
    ...
    {
      question: "৫. n8n এর 3 বছর অফার শেষ হওয়ার পর কি হবে?",
      answer: "3 বছর পর আপনি চাইলে আরো 3 বছরের জন্য n8n রিনিউ করতে পারবেন মাত্র ২০০০ টাকায়। এটি একটি বিশেষ রিনিউয়াল প্রাইস যা আমরা আমাদের স্টুডেন্টদের জন্য অফার করি।"
    },
    {
